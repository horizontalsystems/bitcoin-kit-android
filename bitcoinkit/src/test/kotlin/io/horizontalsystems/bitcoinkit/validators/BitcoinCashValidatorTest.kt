...
class BitcoinCashValidatorTest {
    ...
    fun validateDAA() {
        val candidateHeader = BlockHeader(
                version = 536870912,
                previousBlockHeaderHash = HashUtils.toBytesAsLE("000000000000000000c27f91198eb5505005a0863d8deb696a27e2f5bfffe70b"),
        ...
        blockValidator.validateDAA(candidate, candidate.previousBlock(storage)!!)
    }
    ...
    fun medianTimePast() {
        ...
        val medianTime = blockValidator.medianTimePast(block)
        assertEquals(1600, medianTime)
    }
    ...
    fun getSuitableBlock() {
        ...
        assertEquals(block2, blockValidator.getSuitableBlock(block3))
    }
