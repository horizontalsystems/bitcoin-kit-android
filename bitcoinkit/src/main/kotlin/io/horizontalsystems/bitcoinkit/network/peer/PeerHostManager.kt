...
class PeerHostManager(private val network: Network, private val realmFactory: RealmFactory) {
    ...
    constructor(network: Network, realmFactory: RealmFactory, peerDiscover: PeerDiscover) : this(network, realmFactory) {
